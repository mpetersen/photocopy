...
public class Config extends JsonFile {
  ...
  @JsonProperty("renameOnCopy") private String formatStr;
  @JsonProperty private Path target;
  @JsonProperty private boolean openAfterCopy;
  @JsonProperty("eraseBeforeCopy") private boolean eraseEnabled;
  @JsonProperty("ejectAfterCopy") private boolean ejectEnabled;
  ...
  public Set<Path> getKnownLocations() {
